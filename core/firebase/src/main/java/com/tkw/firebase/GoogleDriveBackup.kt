...
class GoogleDriveBackup @Inject constructor(
    ...
    private val requestedScopes = listOf(Scope(DriveScopes.DRIVE_FILE))
    private val scope = listOf(DriveScopes.DRIVE_FILE)

    override fun upload(token: String?, file: File): String {
