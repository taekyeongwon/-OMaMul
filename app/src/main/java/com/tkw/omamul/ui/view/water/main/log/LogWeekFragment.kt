...
class LogWeekFragment: BaseFragment<FragmentLogWeekBinding, WaterViewModel>(R.layout.fragment_log_week) {
    ...
    override fun bindViewModel(binder: FragmentLogWeekBinding) {
